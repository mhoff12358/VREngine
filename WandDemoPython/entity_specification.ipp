...
CreateVector("VectorIndividualTextureDetails", game_scene::NewIndividualTextureDetails);
...
CreateVector("VectorEntitySpecification", game_scene::EntitySpecification);

class_<game_scene::ComponentInfo>("ComponentInfo", init<string, string>());

CreateVector("VectorComponentInfo", game_scene::ComponentInfo);