...
class TimeRange(object):
    ...
    def InRange(self, time_value):
        after_min = (time_value > self.min_value) or (
            (time_value == self.min_value) and self.min_inclusive)
        before_max = (time_value < self.max_value) or (
            (time_value == self.max_value) and self.max_inclusive)
